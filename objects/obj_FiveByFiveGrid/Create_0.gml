...
//var bottomOfGrid = obj_FiveByFiveGrid.sprite_height - (obj_FiveByFiveGrid.sprite_height / grid_size);
//var _hand = instance_create_layer(obj_FiveByFiveGrid.sprite_width / 2, bottomOfGrid, "Instances", obj_hand);
...
//	// Multiplying the sprite width by the grid position gves
